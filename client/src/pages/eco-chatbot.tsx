...
export default function EcoChatbot() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Could not reach the assistant. Please try again later.",
        variant: "destructive"
      });
    } finally {
      setIsTyping(false);
  ...
  return (
    <div className={isDarkTheme ? 'dark' : ''}>
      <div className="flex h-dvh flex-col overflow-hidden bg-white text-neutral-900 dark:bg-gray-900 dark:text-neutral-100">
        <div className="flex-none"><Header /></div>
        <main className="min-h-0 flex-1 max-w-4xl mx-auto w-full overflow-y-auto px-4 py-8">
          ...
          <div className="border dark:border-gray-700 rounded-lg mb-4 overflow-hidden">
            <div className="chat-scrollbar h-[500px] overflow-y-auto p-4 space-y-4 bg-neutral-50 dark:bg-gray-800">
