...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-[#17352a] py-10 text-white md:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="md:flex md:items-center md:space-x-8">
          <div className="md:w-1/2 mb-8 md:mb-0">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-amber-200">Practical sustainability guidance</p>
          ...
          <div className="md:w-1/2">
            <div className="relative flex min-h-[320px] items-center justify-center overflow-hidden rounded-xl bg-white/10 p-4 shadow-lg sm:p-6 md:aspect-video md:min-h-0">
              <img
              ...
              <div className="relative z-10 grid w-full grid-cols-2 gap-4">
                {/* Impact Stats */}
                <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm sm:p-4">
                  <div className="text-lg font-bold sm:text-2xl">Daily guidance</div>
                  <div className="text-sm opacity-90">Practical eco-friendly tips</div>
                </div>
                <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm sm:p-4">
                  <div className="text-lg font-bold sm:text-2xl">Smart choices</div>
                  <div className="text-sm opacity-90">Lower-waste alternatives</div>
                </div>
                <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm sm:p-4">
                  <div className="text-lg font-bold sm:text-2xl">Live updates</div>
                  <div className="text-sm opacity-90">Environmental news and insights</div>
                </div>
                <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm sm:p-4">
                  <div className="text-lg font-bold sm:text-2xl">Ask anytime</div>
